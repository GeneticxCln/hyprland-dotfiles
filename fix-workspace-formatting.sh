#!/bin/bash
# Fix Workspace Detection formatting issues

# Remove the old file and create a clean one
rm -f configs/quickshell/components/WorkspaceDetection.qml

# Create the clean version
cat > configs/quickshell/components/WorkspaceDetection.qml << 'EOF'
...
echo "✅ WorkspaceDetection.qml formatting fixed!"
